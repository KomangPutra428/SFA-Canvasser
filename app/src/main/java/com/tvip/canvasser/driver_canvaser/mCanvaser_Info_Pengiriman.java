...
import com.tvip.canvasser.menu_mulai_perjalanan.pengiriman_info;
...
public class mCanvaser_Info_Pengiriman extends AppCompatActivity {

    ListView list_pengiriman_terakhir;
    List<data_penjualan_terakhir_pojo> dataPenjualanTerakhirPojos = new ArrayList<>();
    mCanvaser_Info_Pengiriman.ListViewAdapterDaftarKunjunganMain adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mcanvaser_info_pengiriman);
    ...
    private void getPenjualanTerakhir() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://restserver.tvip.co.id:8765/android/"+sharedPreferences.getString("link", null)+"/utilitas/Mulai_Perjalanan/index_infopengiriman_driver?customerId=336-0021814&driver=336-RP049",
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            adapter = new mCanvaser_Info_Pengiriman.ListViewAdapterDaftarKunjunganMain(dataPenjualanTerakhirPojos, getApplicationContext());
...
//                        pDialog.dismissWithAnimation();
    ...
    public class ListViewAdapterDaftarKunjunganMain extends ArrayAdapter<data_penjualan_terakhir_pojo> {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            final mCanvaser_Info_Pengiriman.ListViewAdapterDaftarKunjunganMain.ViewHolder viewHolder;
            data_penjualan_terakhir_pojo movieItem = data_penjualan_terakhir_pojos.get(position);
            if (convertView == null) {
                viewHolder = new mCanvaser_Info_Pengiriman.ListViewAdapterDaftarKunjunganMain.ViewHolder();
                ...
                viewHolder = (mCanvaser_Info_Pengiriman.ListViewAdapterDaftarKunjunganMain.ViewHolder) convertView.getTag();
            }
...
//                        pDialog.dismissWithAnimation();
            ...
            RequestQueue requestQueue = Volley.newRequestQueue(mCanvaser_Info_Pengiriman.this);
            requestQueue.add(stringRequest);
