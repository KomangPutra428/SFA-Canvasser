    ...
    public class ListViewAdapterMateriPosm extends ArrayAdapter<data_posm_pojo> {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                viewHolder.btn_decrease = (ImageButton) convertView.findViewById(R.id.btn_decrease);
                viewHolder.btn_increase = (ImageButton) convertView.findViewById(R.id.btn_increase);
                viewHolder.jumlahqty = (TextView) convertView.findViewById(R.id.jumlahqty);
