...
public class produk_potensial extends AppCompatActivity {
    ...
    private void getProductPotensial() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://restserver.tvip.co.id:8765/android/"+sharedPreferences.getString("link", null)+"/utilitas/Mulai_Perjalanan/index_Product_Penjualan?depo=" + restnomorbaru,
    ...
    public class ListViewAdapteProductPotensial extends ArrayAdapter<data_product_potensial_pojo> {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                viewHolder.qtyorderminus = (ImageButton) convertView.findViewById(R.id.qtyorderminus);
                viewHolder.qtyorderadd = (ImageButton) convertView.findViewById(R.id.qtyorderadd);

                viewHolder.qtyorder = (EditText) convertView.findViewById(R.id.qtyorder);
