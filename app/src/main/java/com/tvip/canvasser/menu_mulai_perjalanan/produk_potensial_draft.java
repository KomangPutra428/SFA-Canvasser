...
import static com.tvip.canvasser.menu_mulai_perjalanan.pelanggan_baru_outlet.fullsegment;
...
import com.tvip.canvasser.pojo.data_product_potensial_pojo;
...
public class produk_potensial_draft extends AppCompatActivity {
    ...
    private void getLastData() {
        ...
        StringRequest biodata = new StringRequest(Request.Method.GET, "https://restserver.tvip.co.id:8765/android/"+sharedPreferences.getString("link", null)+"/utilitas/Mulai_Perjalanan/index_LastId?depo=" + restnomor,
    ...
    private void getRouteItem() {
        ...
        StringRequest biodata = new StringRequest(Request.Method.GET, "https://restserver.tvip.co.id:8765/android/"+sharedPreferences.getString("link", null)+"/utilitas/Mulai_Perjalanan/index_LastRouteItem?employeeId=" + nik_baru,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        postSegment();
    ...
    private void postSegment() {
        StringRequest stringRequest2 = new StringRequest(Request.Method.POST, " https://restserver.tvip.co.id:8765/android/"+sharedPreferences.getString("link", null)+"/utilitas/Mulai_Perjalanan/index_CreateCustomer",
                new Response.Listener<String>() {
    ...
    private void postAlamat() {
        StringRequest stringRequest2 = new StringRequest(Request.Method.POST, " https://restserver.tvip.co.id:8765/android/"+sharedPreferences.getString("link", null)+"/utilitas/Mulai_Perjalanan/index_AlamatCustomer",
                new Response.Listener<String>() {
    ...
    private void postRoute() {
        StringRequest routeinfo = new StringRequest(Request.Method.POST, " https://restserver.tvip.co.id:8765/android/"+sharedPreferences.getString("link", null)+"/utilitas/Mulai_Perjalanan/index_RouteInfoCustomer",
                new Response.Listener<String>() {
        ...
        StringRequest routeitem = new StringRequest(Request.Method.POST, "https://restserver.tvip.co.id:8765/android/"+sharedPreferences.getString("link", null)+"/utilitas/Mulai_Perjalanan/index_RouteItemCustomer",
                new Response.Listener<String>() {
    ...
    private void PostSales() {
        StringRequest topRequest = new StringRequest(Request.Method.POST, " https://restserver.tvip.co.id:8765/android/"+sharedPreferences.getString("link", null)+"/utilitas/Mulai_Perjalanan/index_SalesInfoCustomer",
                new Response.Listener<String>() {
        ...
        StringRequest StructureRequest = new StringRequest(Request.Method.POST, " https://restserver.tvip.co.id:8765/android/"+sharedPreferences.getString("link", null)+"/utilitas/Mulai_Perjalanan/index_StructureCustomer",
                new Response.Listener<String>() {
        ...
        StringRequest TaxInfoCustomer = new StringRequest(Request.Method.POST, " https://restserver.tvip.co.id:8765/android/"+sharedPreferences.getString("link", null)+"/utilitas/Mulai_Perjalanan/index_TaxInfoCustomer",
                new Response.Listener<String>() {
    ...
    private void ProdukPotensial() {
        ...
        for(int i = 0; i < produk_potensial.dataDraft.size(); i ++){
            int finalI = i;
            StringRequest ProductPotential = new StringRequest(Request.Method.POST, "https://restserver.tvip.co.id:8765/android/"+sharedPreferences.getString("link", null)+"/utilitas/Mulai_Perjalanan/index_ProductPotential",
                    new Response.Listener<String>() {
    ...
    private void getSOBaru() {
        ...
        String restnomor = parts[0];
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://restserver.tvip.co.id:8765/android/"+sharedPreferences.getString("link", null)+"/utilitas/Mulai_Perjalanan/index_NoSoPelanggan?depo=" + restnomor,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
...
//                        pDialog.dismissWithAnimation();
    ...
    private void getJumlah(String data_id) {
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://restserver.tvip.co.id:8765/android/"+sharedPreferences.getString("link", null)+"/utilitas/Mulai_Perjalanan/index_List_Dalam_Pelanggan?surat_tugas=" + mulai_perjalanan.id_pelanggan,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
    ...
    public class ListViewAdapteProductDraft extends ArrayAdapter<data_product_potensial_pojo> {
        private List<data_product_potensial_pojo> totalPenjualanPojos;
