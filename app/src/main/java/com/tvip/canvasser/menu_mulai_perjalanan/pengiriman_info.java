...
public class pengiriman_info extends AppCompatActivity {
    ...
    private void getPenjualanTerakhir() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://restserver.tvip.co.id:8765/android/"+sharedPreferences.getString("link", null)+"/utilitas/Mulai_Perjalanan/index_PenjualanTerakhir?szCustomerId=" + no_surat,
...
//                        pDialog.dismissWithAnimation();
    ...
    public class ListViewAdapterDaftarKunjunganMain extends ArrayAdapter<data_penjualan_terakhir_pojo> {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://restserver.tvip.co.id:8765/android/"+sharedPreferences.getString("link", null)+"/utilitas/Mulai_Perjalanan/index_PenjualanTerakhirProduk?surat_tugas=" + movieItem.getSzDocId(),
                    new Response.Listener<String>() {
                        @Override
                        public void onResponse(String response) {
...
//                        pDialog.dismissWithAnimation();
    ...
    public static class ListViewAdapterDaftarKunjunganMainSub extends ArrayAdapter<data_product_pojo> {
        private List<data_product_pojo> data_pelanggans;
