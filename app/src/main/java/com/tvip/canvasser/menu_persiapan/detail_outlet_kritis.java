...
import com.tvip.canvasser.pojo.SO_pojo;
import com.tvip.canvasser.pojo.piutang_pojo;
import com.tvip.canvasser.pojo.so_sub_pojio;
import com.tvip.canvasser.pojo.trend_produk_pojo;
...
public class detail_outlet_kritis extends AppCompatActivity {
    ScrollView tipetoko;
    ...
    ListViewAdapterinfoPiutang adapter2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_outlet_kritis);
    ...
    private void getTrend() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://restserver.tvip.co.id:8765/android/"+sharedPreferences.getString("link", null)+"/utilitas/Persiapan/index_TrendSalesListProduk?tanggal="+dateOutput+"&szCustomerId=" + getIntent().getStringExtra("SzId"),
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        try {
...
//                        pDialog.dismissWithAnimation();
    ...
    private void getPiutang() {
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://restserver.tvip.co.id:8765/android/"+sharedPreferences.getString("link", null)+"/utilitas/Persiapan/index_InfoPiutang?szCustomerId=" + getIntent().getStringExtra("SzId"),
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < movieArray.length(); i++) {
                                ...
                                adapter2 = new ListViewAdapterinfoPiutang(piutang_pojos, getApplicationContext());
...
//                        pDialog.dismissWithAnimation();
    ...
    private void getSOHistory() {
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://restserver.tvip.co.id:8765/android/"+sharedPreferences.getString("link", null)+"/utilitas/Mulai_Perjalanan/index_HistoryPenjualan?szCustomerId=" + getIntent().getStringExtra("SzId"),
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
    ...
    public class ListViewAdapterTrendPenjualan extends ArrayAdapter<trend_produk_pojo> {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                viewHolder.progress = (LinearLayout) convertView.findViewById(R.id.progress);

                viewHolder.unhide = (ImageButton) convertView.findViewById(R.id.unhide);
                viewHolder.hide = (ImageButton) convertView.findViewById(R.id.hide);

                viewHolder.minggu1 = (ImageView) convertView.findViewById(R.id.minggu1);
                viewHolder.minggu2 = (ImageView) convertView.findViewById(R.id.minggu2);
                viewHolder.minggu3 = (ImageView) convertView.findViewById(R.id.minggu3);
                viewHolder.minggu4 = (ImageView) convertView.findViewById(R.id.minggu4);
                viewHolder.minggu5 = (ImageView) convertView.findViewById(R.id.minggu5);
                viewHolder.minggu6 = (ImageView) convertView.findViewById(R.id.minggu6);
                viewHolder.minggu7 = (ImageView) convertView.findViewById(R.id.minggu7);
                viewHolder.minggu8 = (ImageView) convertView.findViewById(R.id.minggu8);
    ...
    public class ListViewAdapterSO extends ArrayAdapter<SO_pojo> {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                viewHolder.noso = (TextView) convertView.findViewById(R.id.noso);
                viewHolder.List_sub_penjualan = (ListView) convertView.findViewById(R.id.List_sub_penjualan);
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://restserver.tvip.co.id:8765/android/"+sharedPreferences.getString("link", null)+"/utilitas/Mulai_Perjalanan/index_HistoryPenjualanSub?szDocId=" + movieItem.getSzDocId(),
                    new Response.Listener<String>() {
                        @Override
                        public void onResponse(String response) {
...
//                        pDialog.dismissWithAnimation();
            ...
            RequestQueue requestQueue = Volley.newRequestQueue(detail_outlet_kritis.this);
            requestQueue.add(stringRequest);
    ...
    public class ListViewAdapterSOSub extends ArrayAdapter<so_sub_pojio> {
        private List<so_sub_pojio> soSubPojios;
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            qty_order.setText(data.getDecPrice());

            return listViewItem;
        }
    }

    public class ListViewAdapterinfoPiutang extends ArrayAdapter<piutang_pojo> {
        private List<piutang_pojo> piutang_pojos;

        private Context context;

        public ListViewAdapterinfoPiutang(List<piutang_pojo> piutang_pojos, Context context) {
