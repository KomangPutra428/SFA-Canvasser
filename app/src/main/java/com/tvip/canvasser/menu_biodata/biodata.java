package com.tvip.canvasser.menu_biodata;
...
public class biodata extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StringRequest total = new StringRequest(Request.Method.GET, "http://assessment.tvip.co.id/rest_server/pengajuan/punishment/index?nik_baru="+ nik_baru,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        try {
